...
export class GreenShip extends Container implements IShip {
    ...
    private initialize(sceneSize: Size): void {
        ...
        const shipRect = graphics.rect(0, 0, shipWeight, shipHeight).fill({color: '#2fff00', alpha: 0}).stroke({
            width: 4,
            color: '#2fff00'
        });
